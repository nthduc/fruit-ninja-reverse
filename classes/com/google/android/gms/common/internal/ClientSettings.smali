...
.field private final zaoi:Ljava/util/Map;
...
.field private final zaoj:I

.field private final zaok:Landroid/view/View;

.field private final zaol:Ljava/lang/String;

.field private final zaom:Ljava/lang/String;

.field private final zaon:Lcom/google/android/gms/signin/SignInOptions;

.field private final zaop:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.field private final zaoq:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/android/gms/common/api/Scope;",
...
.method public constructor <init>(Landroid/accounts/Account;Ljava/util/Set;Ljava/util/Map;ILandroid/view/View;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/signin/SignInOptions;Z)V
    ...
    :goto_10
    iput-object p1, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaop:Ljava/util/Set;
    ...
    :cond_18
    iput-object p3, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoi:Ljava/util/Map;

    .line 10
    iput-object p5, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaok:Landroid/view/View;

    .line 11
    iput p4, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoj:I

    .line 12
    iput-object p6, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaol:Ljava/lang/String;

    .line 13
    iput-object p7, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaom:Ljava/lang/String;

    .line 14
    iput-object p8, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaon:Lcom/google/android/gms/signin/SignInOptions;

    .line 15
    iput-boolean p9, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaor:Z

    .line 16
    new-instance p1, Ljava/util/HashSet;

    iget-object p2, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaop:Ljava/util/Set;

    invoke-direct {p1, p2}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    .line 17
    iget-object p2, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoi:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoq:Ljava/util/Set;
...
.method public final getAllRequestedScopes()Ljava/util/Set;
    ...
    .line 30
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoq:Ljava/util/Set;
...
.method public final getApplicableScopes(Lcom/google/android/gms/common/api/Api;)Ljava/util/Set;
    ...
    .line 39
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoi:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaop:Ljava/util/Set;
    ...
    :cond_20
    :goto_20
    iget-object p1, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaop:Ljava/util/Set;
...
.method public final getClientSessionId()Ljava/lang/Integer;
    ...
    .line 36
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaos:Ljava/lang/Integer;
...
.method public final getGravityForPopups()I
    ...
    .line 28
    iget v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaoj:I
...
.method public final getRealClientClassName()Ljava/lang/String;
    ...
    .line 33
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaom:Ljava/lang/String;
...
.method public final getRequiredScopes()Ljava/util/Set;
    ...
    .line 29
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaop:Ljava/util/Set;
...
.method public final getSignInOptions()Lcom/google/android/gms/signin/SignInOptions;
    ...
    .line 35
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaon:Lcom/google/android/gms/signin/SignInOptions;
...
.method public final getViewForPopups()Landroid/view/View;
    ...
    .line 34
    iget-object v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaok:Landroid/view/View;
...
.method public final isSignInClientDisconnectFixEnabled()Z
    ...
    .line 45
    iget-boolean v0, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaor:Z
...
.method public final setClientSessionId(Ljava/lang/Integer;)V
    ...
    .line 37
    iput-object p1, p0, Lcom/google/android/gms/common/internal/ClientSettings;->zaos:Ljava/lang/Integer;
