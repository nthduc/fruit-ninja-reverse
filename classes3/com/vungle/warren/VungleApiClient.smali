...
.method constructor <init>(Landroid/content/Context;Lcom/vungle/warren/persistence/CacheManager;Lcom/vungle/warren/persistence/Repository;)V
    ...
    iput-object p2, p0, Lcom/vungle/warren/VungleApiClient;->client:Lokhttp3/OkHttpClient;
    :try_end_30
    .catch Ljava/lang/ExceptionInInitializerError; {:try_start_2a .. :try_end_30} :catch_5f
    .catch Ljava/lang/NoClassDefFoundError; {:try_start_2a .. :try_end_30} :catch_5d
...
.method private getDeviceBody()Lcom/google/gson/JsonObject;
    ...
    if-eq v12, v5, :cond_1b9

    const/4 v11, 0x6

    if-eq v12, v11, :cond_1b9

    const/4 v11, 0x7

    if-eq v12, v11, :cond_1b6

    const/16 v11, 0x9

    if-eq v12, v11, :cond_1b3
    ...
    move-result v0
    :try_end_31e
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_2f2 .. :try_end_31e} :catch_322

    if-ne v0, v5, :cond_32a
...
.method private declared-synchronized init(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_end_14
    .catchall {:try_start_1 .. :try_end_14} :catchall_129
    ...
    .catchall {:try_start_15 .. :try_end_24} :catchall_129
    ...
    :try_end_ab
    .catchall {:try_start_24 .. :try_end_ab} :catchall_129
    ...
    :try_end_100
    .catch Ljava/lang/Exception; {:try_start_ab .. :try_end_100} :catch_101
    .catchall {:try_start_ab .. :try_end_100} :catchall_129
    ...
    :try_end_127
    .catchall {:try_start_102 .. :try_end_127} :catchall_129
...
.method public pingTPAT(Ljava/lang/String;)Z
    ...
    move-result-object v0
    :try_end_17
    .catch Ljava/net/MalformedURLException; {:try_start_e .. :try_end_17} :catch_5d
    ...
    :try_end_53
    .catch Ljava/io/IOException; {:try_start_48 .. :try_end_53} :catch_54
