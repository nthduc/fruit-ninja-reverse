...
.method protected varargs doInBackground([Ljava/lang/Void;)Lcom/vungle/warren/AdvertisementPresentationFactory$PresentationResultHolder;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/vungle/warren/AdvertisementPresentationFactory$NativeViewPresentationTask;->loadPresentationData(Ljava/lang/String;Landroid/os/Bundle;)Landroid/util/Pair;

    move-result-object p1
    :try_end_8
    .catch Lcom/vungle/warren/error/VungleException; {:try_start_0 .. :try_end_8} :catch_11e
    ...
    .line 435
    :try_start_d8
    iget-object v1, p0, Lcom/vungle/warren/AdvertisementPresentationFactory$NativeViewPresentationTask;->repository:Lcom/vungle/warren/persistence/Repository;

    invoke-virtual {v1, v2}, Lcom/vungle/warren/persistence/Repository;->save(Ljava/lang/Object;)V
    :try_end_dd
    .catch Lcom/vungle/warren/persistence/DatabaseHelper$DBException; {:try_start_d8 .. :try_end_dd} :catch_ff
